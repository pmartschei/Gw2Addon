...
extern uint GameWidth, GameHeight;
...
void RenderTextPre(const char* label, std::vector<TooltipColor> tooltips = std::vector<TooltipColor>());

bool RenderInputText(const char* label, std::string& value, int size, std::vector<TooltipColor> tooltips = std::vector<TooltipColor>());
bool RenderCheckbox(const char* label,bool* b, std::vector<TooltipColor> tooltips = std::vector<TooltipColor>());
bool RenderInputInt(const char*label, int* value, int min = 0, int max = 0, std::vector<TooltipColor> tooltips = std::vector<TooltipColor>());
bool RenderSliderInt(const char*label, int* value, int min = 0, int max = 0, std::vector<TooltipColor> tooltips = std::vector<TooltipColor>());
